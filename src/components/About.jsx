...
const About = () => {
  return (
    <div className="px-5 md:px-15 py-15 md:py-30 flex flex-col md:flex-row bg-secondary gap-10">
      <Reveal className="w-full md:w-1/2 px-0 lg:px-10 flex flex-col justify-center gap-6 md:gap-10 order-2 md:order-1">
        <h2 className="text-3xl md:text-5xl">About Dr. Maya Reynolds, PsyD</h2>
        <p className="text-lg text-muted md:text-xl">I'm a licensed clinical psychologist in Santa Monica who works with adults navigating anxiety, trauma, and professional burnout. My approach is warm, collaborative, and grounded—combining CBT, EMDR, mindfulness, and body-oriented techniques to support lasting change.</p>
